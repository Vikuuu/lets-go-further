...
func ValidateMovie(v *validator.Validator, movie *Movie) {
	...
	v.Check(len(movie.Title) <= 500, "title", "must be not more that 500 bytes")
	...
	v.Check(len(movie.Genres) >= 1, "genres", "must contain atleast 1 genres")
	v.Check(len(movie.Genres) <= 5, "genres", "must not contain more that 5 genres")
